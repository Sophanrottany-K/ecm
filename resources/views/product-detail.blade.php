                    ...
                    <div class="col-lg-5 right-info">
                        ...
                        <ul class="list-unstyled small text mb-3">
                            ...
                            <li class="mb-1"><i class="bi bi-credit-card me-1"></i> ការទូរទាត់: ABA • Wing • ACLEDA •
                                Vattanac • COD</li>
                            <li class="mb-1"><i class="bi bi-shield-check me-1"></i>ផ្ញើត្រឡប់មកវិញដោយឥតគិតថ្លៃក្នុងរយៈពេល
                                7 ថ្ងៃ
                                បើសិនទំនិញមានបញ្ហា
                            </li>
                        </ul>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <div class="text">
                                        តម្លៃក្នុង1: <span class="text-warning"> $<span id="unitPrice">5</span></span><br>
